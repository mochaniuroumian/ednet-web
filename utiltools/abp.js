...
;(function() {
    ...
    abp.localization.cookieName = '.AspNetCore.Culture'
    ...
    abp.notifications.showUiNotifyForUserNotification = function(userNotification, options) {
        ...
        const uiNotifyFunc = abp.notifications.getUiNotifyFuncBySeverity(userNotification.notification.severity)
    ...
    const showMessage = function(message, title) {
        alert((title || '') + ' ' + message)
    }
    ...
    abp.timing.convertToUserTimezone = function(date) {
        ...
        const targetTime = parseInt(utcTime) + parseInt(abp.timing.timeZoneInfo.windows.currentUtcOffsetInMilliseconds)
